...
class CommerceFraudSettingsForm extends ConfigFormBase {
  ...
  public static function create(ContainerInterface $container) {
    return new static(
      ...
      $container->get('plugin.manager.commerce_fraud_generator')
    );
  }
  ...
  drupal_set_message($this->commerceFraudManager->getDefinitions());
    ...
    $form['generator']['generator'] = [
      ...
      '#description' => $this->t('Choose the plugin to be used for fraud generation.'),
    ];
