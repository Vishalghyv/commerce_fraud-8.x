...
/**
 * Provides a form for deleting a commerce_fraud entity.
 *
 * @ingroup commerce_fraud
 */
class RulesDeleteForm extends ContentEntityConfirmFormBase {
  ...
  public function submitForm(array &$form, FormStateInterface $form_state) {
    ...
    $this->logger('commerce_fraud')->notice('deleted %title.',
      array(
