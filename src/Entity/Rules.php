...
use Drupal\commerce_fraud\RuleInterface;
 ...
 * @ContentEntityType(
 *   id = "rules",
 *   label = @Translation("Rules entity"),
 *   handlers = {
 ...
 *   },
 *   base_table = "commerce_fraud_rules",
 *   admin_permission = "administer rules entity",
 *   fieldable = TRUE,
 *   entity_keys = {
 *     "id" = "id",
 *     "label" = "name",
 ...
 *     "edit-form" = "/rules/{rules}/edit",
 *     "delete-form" = "/rules/{rules}/delete",
 *     "collection" = "/rules/list"
 *   },
 *   *   field_ui_base_route = "commerce_fraud.settings",
 * )
 *
 ...
 * field.
 */
class Rules extends ContentEntityBase implements RuleInterface {
